...
import { 
  CheckCircle2, ChevronRight, ChevronLeft, Upload, Plus, Trash2, Calendar, DollarSign, Image as ImageIcon, Video
} from 'lucide-react';
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {['Reward-based', 'Donation-based', 'Milestone-based'].map((type) => (
                      <div key={type} className="border rounded-lg p-4 cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all">
